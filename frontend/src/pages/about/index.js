    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/YU-K/foodgram" className={styles.textLink}>https://github.com/YU-K/foodgram</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/YU-K" className={styles.textLink}>Катков Юрий</a>
            </p>
          </div>
        </aside>
      </div>
